	...
	const listItems = items.map((items) => {
		return (
			<tr key={items.name} className="invoice-medicine-list">
				<td className="invoice-medicine-list-name">
					<p>{items.name}</p>
				</td>
				<td className="invoice-medicine-list-qty">
					<p>{items.qty}</p>
				</td>
				<td className="invoice-medicine-list-price">
					<p>{items.price}</p>
				</td>
				<td>
					<input
						...
						alt="meditech-cancel-icon"
						onClick={() => props.deleteItem(items.name)}
					/>
				</td>
			</tr>
		);
